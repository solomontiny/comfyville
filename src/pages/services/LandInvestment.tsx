...
const LandInvestment = () => (
  <main className="pt-20 md:pt-24">
    <section className="relative h-[55vh] min-h-[400px] flex items-center overflow-hidden">
      <img src={heroImage} alt="Land & Investment" className="absolute inset-0 w-full h-full object-cover" />
      ...
      <div className="container relative z-10">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <h1 className="font-display text-4xl md:text-6xl font-bold text-white">Land & Investment Advisory</h1>
        </motion.div>
      </div>
    </section>
    ...
    <section className="container py-24 max-w-4xl">
      <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
        ...
        <h2 className="font-display text-3xl md:text-4xl font-semibold text-foreground mb-6">Smart Investments, Solid Returns</h2>
        <div className="luxury-divider mb-8" />
        <p className="text-muted-foreground leading-relaxed text-lg font-light">
          Navigate the Nigerian real estate investment landscape with confidence. From land acquisition to portfolio strategy, our advisory team provides the insight and expertise you need to make informed, profitable decisions.
        </p>
      </motion.div>
    </section>
